...
let skyProgram, locSkyVP, locSkySampler;
let labelProgram, locLabelVP, locLabelUV, locLabelTex;
let cubeVao, quadVao;
let texBright, texDim, texLabels;
...
// ---------------------------------------------------------------- drawing
function drawScene(projMatrix, viewRotMatrix, rightEye) {
...
async function main() {
  ...
  [texBright, texDim, texLabels] = await Promise.all([
